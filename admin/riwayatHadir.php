...
$halaman = 'riwayatHadir';
$tanggal = getToday();
$Sabsen = query("SELECT * FROM absen" );

if ( isset($_POST["cari"]))
{
    $Sabsen = Hcari($_POST["input"]); 
}
...
<html lang="en">
  <head>
    ...
    <title>Riwayat Hadir | Admin</title>
      ...
      <div class="p-4 flex-grow-1 bg-dark-subtle">
        ...
        <div class="container mt-4">
          ...
          <div class="d-flex justify-content-between">
            ...
            <form class="d-flex">
              <!-- shearcing -->
              <input class="form-control me-2" type="text" name="input" autofocus placeholder="Search.." aria-label="Search" id="keyword"/>
              <button class="btn btn-primary" type="submit" name="cari" id="tombol-cari"></button>
            </form>
          </div>
          <!--  -->
           <div id="container">
